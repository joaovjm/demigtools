...
import { FaTasks, FaUser, FaReceipt, FaSpinner, FaSave, FaTimes, FaTrash, FaBan } from 'react-icons/fa'
...
const ModalTaskDetails = ({ task, onClose, onUpdate, statusOptions }) => {
  ...
  const fetchOperators = async () => {
    try {
      const data = await getOperators({ active: true, item: 'operator_code_id, operator_name' })
      setOperators(data || [])
    } catch (error) {
  ...
  const handleCancelReceipt = async () => {
    if (!window.confirm('Deseja realmente cancelar esta ficha? O coletador será alterado para 11.')) return
  ...
  const handleDeleteReceipt = async () => {
    if (!window.confirm('Deseja realmente EXCLUIR esta ficha? Esta ação não pode ser desfeita!')) return
        ...
        <div className={styles.modalContent}>
          ...
          <div className={styles.modalBody}>
            ...
            <div className={styles.formSection}>
              ...
              <div className={styles.formGrid}>
                ...
                <div className={styles.inputGroup}>
                  ...
                  <input
                    type="text"
                    value={task?.operator_conclude_info?.operator_name || 'Não atribuído'}
                    readOnly
                    className={styles.readOnly}
                  />
                </div>
                    ...
                    <div className={styles.formGrid}>
                      <div className={styles.inputGroup}>
                        ...
                        <input
                          ...
                          onChange={(e) => handleDonorInputChange('nome', e.target.value)}
                        />
                      </div>
                      <div className={styles.inputGroup}>
                        <label>Tipo</label>
                        <select
                          ...
                          onChange={(e) => handleDonorInputChange('tipo', e.target.value)}
                        >
                      ...
                      <div className={styles.inputGroup}>
                        ...
                        <input
                          type="text"
                          value={donorForm.cpf}
                          onChange={(e) => handleDonorInputChange('cpf', e.target.value)}
                        />
                      </div>
                      <div className={styles.inputGroup}>
                        <label>Email</label>
                      ...
                      <div className={styles.inputGroup}>
                        ...
                        <input
                          ...
                          onChange={(e) => handleDonorInputChange('endereco', e.target.value)}
                        />
                      </div>
                      <div className={styles.inputGroup}>
                        <label>Cidade</label>
                        <input
                          ...
                          onChange={(e) => handleDonorInputChange('cidade', e.target.value)}
                        />
                      </div>
                      <div className={styles.inputGroup}>
                        <label>Bairro</label>
                        <input
                          ...
                          onChange={(e) => handleDonorInputChange('bairro', e.target.value)}
                        />
                      </div>
                      <div className={styles.inputGroup}>
                        ...
                        <input
                          ...
                          onChange={(e) => handleDonorInputChange('telefone1', e.target.value)}
                        />
                      </div>
                      <div className={styles.inputGroup}>
                        ...
                        <input
                          ...
                          onChange={(e) => handleDonorInputChange('telefone2', e.target.value)}
                        />
                      </div>
                      <div className={styles.inputGroup}>
                        ...
                        <input
                          ...
                          onChange={(e) => handleDonorInputChange('telefone3', e.target.value)}
                        />
                      </div>
                        ...
                        <>
                          <div className={styles.inputGroup}>
                            ...
                            <input
                              type="number"
                              value={donorForm.dia}
                              onChange={(e) => handleDonorInputChange('dia', e.target.value)}
                              min="1"
                              max="31"
                            />
                          </div>
                          <div className={styles.inputGroup}>
                            ...
                            <input
                              ...
                              onChange={(e) => handleDonorInputChange('mensalidade', e.target.value)}
                              step="0.01"
                            />
                          </div>
                        </>
                      ...
                      <div className={`${styles.inputGroup} ${styles.fullWidth}`}>
                        ...
                        <textarea
                          ...
                          onChange={(e) => handleDonorInputChange('observacao', e.target.value)}
                          rows={2}
                        />
                      </div>
                      <div className={`${styles.inputGroup} ${styles.fullWidth}`}>
                        ...
                        <textarea
                          ...
                          onChange={(e) => handleDonorInputChange('referencia', e.target.value)}
                          rows={2}
                        />
                      </div>
                    </div>
            ...
            {task?.receipt_donation_id && (
              <div className={styles.formSection}>
                <h3><FaReceipt /> Dados do Recibo</h3>
                {donationLoading ? (
                  <div className={styles.loadingSection}>
                    <FaSpinner className={styles.spinner} />
                    ...
                    <div className={styles.formGrid}>
                      ...
                      <div className={styles.inputGroup}>
                        ...
                        <input
                          ...
                          onChange={(e) => handleDonationInputChange('value', e.target.value)}
                          step="0.01"
                        />
                      </div>
                      <div className={styles.inputGroup}>
                        ...
                        <input
                          ...
                          onChange={(e) => handleDonationInputChange('date', e.target.value)}
                        />
                      </div>
                      <div className={styles.inputGroup}>
                        ...
                        <select
                          ...
                          onChange={(e) => handleDonationInputChange('collector', e.target.value)}
                        >
                          <option value="">Selecione...</option>
                          {collectors.map(c => (
                            <option key={c.collector_code_id} value={c.collector_code_id}>
                              {c.collector_name}
                            </option>
                          ))}
                        </select>
                      ...
                      <div className={styles.inputGroup}>
                        ...
                        <select
                          ...
                          onChange={(e) => handleDonationInputChange('operator', e.target.value)}
                        >
                          <option value="">Selecione...</option>
                          {operators.map(op => (
                      ...
                      <div className={`${styles.inputGroup} ${styles.fullWidth}`}>
                        ...
                        <textarea
                          ...
                          onChange={(e) => handleDonationInputChange('observation', e.target.value)}
                          rows={2}
                        />
                      </div>
                    </div>
